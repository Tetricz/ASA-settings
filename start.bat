...
cd "%Executable_Dir%"
start "" /w /high "%Server_Executable%" start ArkAscendedServer TheIsland_WP?NA-PVP-Smalltribes-4p-2xT-No Offline Raid?Listen -NoBattlEye exit &:: Using "-log" Will Prevent Automatic Crash Detection
echo Crash Detected!
echo.
